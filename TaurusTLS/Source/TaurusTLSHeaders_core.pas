/// <exclude />
  (* This unit was generated using the script genTaurusTLSHdrs.sh from the source file TaurusTLSHeaders_core.h2pas
     It should not be modified directly. All changes should be made to TaurusTLSHeaders_core.h2pas
     and this file regenerated. TaurusTLSHeaders_core.h2pas is distributed with the full Indy
     Distribution.
   *)
...
{$ENDIF}
   ...
   * ----------
   *
   * These are the types that the TaurusTLS core and providers have in common
  ...
  {$EXTERNALSYM ossl_algorithm_st}
     ...
     * module, that module is not an TaurusTLS provider module.
      }
    {-
