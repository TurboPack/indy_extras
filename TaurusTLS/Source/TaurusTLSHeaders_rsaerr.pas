/// <exclude />
  (* This unit was generated using the script genTaurusTLSHdrs.sh from the source file TaurusTLSHeaders_rsaerr.h2pas
     It should not be modified directly. All changes should be made to TaurusTLSHeaders_rsaerr.h2pas
     and this file regenerated. TaurusTLSHeaders_rsaerr.h2pas is distributed with the full Indy
     Distribution.
   *)
...
const
   ...
   * RSA function codes.
   *)
  {$EXTERNALSYM RSA_F_CHECK_PADDING_MD}
  RSA_F_CHECK_PADDING_MD = 140;
  {$EXTERNALSYM RSA_F_ENCODE_PKCS1}
  RSA_F_ENCODE_PKCS1 = 146;
  {$EXTERNALSYM RSA_F_INT_RSA_VERIFY}
  RSA_F_INT_RSA_VERIFY = 145;
  {$EXTERNALSYM RSA_F_OLD_RSA_PRIV_DECODE}
  RSA_F_OLD_RSA_PRIV_DECODE = 147;
  {$EXTERNALSYM RSA_F_PKEY_PSS_INIT}
  RSA_F_PKEY_PSS_INIT = 165;
  {$EXTERNALSYM RSA_F_PKEY_RSA_CTRL}
  RSA_F_PKEY_RSA_CTRL = 143;
  {$EXTERNALSYM RSA_F_PKEY_RSA_CTRL_STR}
  RSA_F_PKEY_RSA_CTRL_STR = 144;
  {$EXTERNALSYM RSA_F_PKEY_RSA_SIGN}
  RSA_F_PKEY_RSA_SIGN = 142;
  {$EXTERNALSYM RSA_F_PKEY_RSA_VERIFY}
  RSA_F_PKEY_RSA_VERIFY = 149;
  {$EXTERNALSYM RSA_F_PKEY_RSA_VERIFYRECOVER}
  RSA_F_PKEY_RSA_VERIFYRECOVER = 141;
  {$EXTERNALSYM RSA_F_RSA_ALGOR_TO_MD}
  RSA_F_RSA_ALGOR_TO_MD = 156;
  {$EXTERNALSYM RSA_F_RSA_BUILTIN_KEYGEN}
  RSA_F_RSA_BUILTIN_KEYGEN = 129;
  {$EXTERNALSYM RSA_F_RSA_CHECK_KEY}
  RSA_F_RSA_CHECK_KEY = 123;
  {$EXTERNALSYM RSA_F_RSA_CHECK_KEY_EX}
  RSA_F_RSA_CHECK_KEY_EX = 160;
  {$EXTERNALSYM RSA_F_RSA_CMS_DECRYPT}
  RSA_F_RSA_CMS_DECRYPT = 159;
  {$EXTERNALSYM RSA_F_RSA_CMS_VERIFY}
  RSA_F_RSA_CMS_VERIFY = 158;
  {$EXTERNALSYM RSA_F_RSA_ITEM_VERIFY}
  RSA_F_RSA_ITEM_VERIFY = 148;
  {$EXTERNALSYM RSA_F_RSA_METH_DUP}
  RSA_F_RSA_METH_DUP = 161;
  {$EXTERNALSYM RSA_F_RSA_METH_NEW}
  RSA_F_RSA_METH_NEW = 162;
  {$EXTERNALSYM RSA_F_RSA_METH_SET1_NAME}
  RSA_F_RSA_METH_SET1_NAME = 163;
  {$EXTERNALSYM RSA_F_RSA_MGF1_TO_MD}
  RSA_F_RSA_MGF1_TO_MD = 157;
  {$EXTERNALSYM RSA_F_RSA_MULTIP_INFO_NEW}
  RSA_F_RSA_MULTIP_INFO_NEW = 166;
  {$EXTERNALSYM RSA_F_RSA_NEW_METHOD}
  RSA_F_RSA_NEW_METHOD = 106;
  {$EXTERNALSYM RSA_F_RSA_NULL}
  RSA_F_RSA_NULL = 124;
  {$EXTERNALSYM RSA_F_RSA_NULL_PRIVATE_DECRYPT}
  RSA_F_RSA_NULL_PRIVATE_DECRYPT = 132;
  {$EXTERNALSYM RSA_F_RSA_NULL_PRIVATE_ENCRYPT}
  RSA_F_RSA_NULL_PRIVATE_ENCRYPT = 133;
  {$EXTERNALSYM RSA_F_RSA_NULL_PUBLIC_DECRYPT}
  RSA_F_RSA_NULL_PUBLIC_DECRYPT = 134;
  {$EXTERNALSYM RSA_F_RSA_NULL_PUBLIC_ENCRYPT}
  RSA_F_RSA_NULL_PUBLIC_ENCRYPT = 135;
  {$EXTERNALSYM RSA_F_RSA_OSSL_PRIVATE_DECRYPT}
  RSA_F_RSA_OSSL_PRIVATE_DECRYPT = 101;
  {$EXTERNALSYM RSA_F_RSA_OSSL_PRIVATE_ENCRYPT}
  RSA_F_RSA_OSSL_PRIVATE_ENCRYPT = 102;
  {$EXTERNALSYM RSA_F_RSA_OSSL_PUBLIC_DECRYPT}
  RSA_F_RSA_OSSL_PUBLIC_DECRYPT = 103;
  {$EXTERNALSYM RSA_F_RSA_OSSL_PUBLIC_ENCRYPT}
  ...
  {$EXTERNALSYM RSA_F_RSA_PADDING_ADD_PKCS1_OAEP_MGF1}
  RSA_F_RSA_PADDING_ADD_PKCS1_OAEP_MGF1 = 154;
  {$EXTERNALSYM RSA_F_RSA_PADDING_ADD_PKCS1_PSS}
  RSA_F_RSA_PADDING_ADD_PKCS1_PSS = 125;
  {$EXTERNALSYM RSA_F_RSA_PADDING_ADD_PKCS1_PSS_MGF1}
  ...
  {$EXTERNALSYM RSA_F_RSA_PADDING_ADD_X931}
  ...
  {$EXTERNALSYM RSA_F_RSA_PADDING_CHECK_PKCS1_OAEP_MGF1}
  ...
  {$EXTERNALSYM RSA_F_RSA_PADDING_CHECK_X931}
  RSA_F_RSA_PADDING_CHECK_X931 = 128;
  {$EXTERNALSYM RSA_F_RSA_PARAM_DECODE}
  RSA_F_RSA_PARAM_DECODE = 164;
  {$EXTERNALSYM RSA_F_RSA_PRINT}
  RSA_F_RSA_PRINT = 115;
  {$EXTERNALSYM RSA_F_RSA_PRINT_FP}
  RSA_F_RSA_PRINT_FP = 116;
  {$EXTERNALSYM RSA_F_RSA_PRIV_DECODE}
  RSA_F_RSA_PRIV_DECODE = 150;
  {$EXTERNALSYM RSA_F_RSA_PRIV_ENCODE}
  RSA_F_RSA_PRIV_ENCODE = 138;
  {$EXTERNALSYM RSA_F_RSA_PSS_GET_PARAM}
  RSA_F_RSA_PSS_GET_PARAM = 151;
  {$EXTERNALSYM RSA_F_RSA_PSS_TO_CTX}
  RSA_F_RSA_PSS_TO_CTX = 155;
  {$EXTERNALSYM RSA_F_RSA_PUB_DECODE}
  ...
  {$EXTERNALSYM RSA_F_RSA_VERIFY_PKCS1_PSS_MGF1}
  RSA_F_RSA_VERIFY_PKCS1_PSS_MGF1 = 126;
  {$EXTERNALSYM RSA_F_SETUP_TBUF}
  ...
  {$EXTERNALSYM RSA_R_DATA_TOO_LARGE_FOR_MODULUS}
  ...
  {$EXTERNALSYM RSA_R_DIGEST_DOES_NOT_MATCH}
  RSA_R_DIGEST_DOES_NOT_MATCH = 158;
  {$EXTERNALSYM RSA_R_DIGEST_NOT_ALLOWED}
  ...
  {$EXTERNALSYM RSA_R_FIRST_OCTET_INVALID}
  RSA_R_FIRST_OCTET_INVALID = 133;
  {$EXTERNALSYM RSA_R_ILLEGAL_OR_UNSUPPORTED_PADDING_MODE}
  RSA_R_ILLEGAL_OR_UNSUPPORTED_PADDING_MODE = 144;
  {$EXTERNALSYM RSA_R_INVALID_DIGEST}
  RSA_R_INVALID_DIGEST = 157;
  {$EXTERNALSYM RSA_R_INVALID_DIGEST_LENGTH}
  RSA_R_INVALID_DIGEST_LENGTH = 143;
  {$EXTERNALSYM RSA_R_INVALID_HEADER}
  RSA_R_INVALID_HEADER = 137;
  {$EXTERNALSYM RSA_R_INVALID_LABEL}
  RSA_R_INVALID_LABEL = 160;
  {$EXTERNALSYM RSA_R_INVALID_MESSAGE_LENGTH}
  RSA_R_INVALID_MESSAGE_LENGTH = 131;
  {$EXTERNALSYM RSA_R_INVALID_MGF1_MD}
  RSA_R_INVALID_MGF1_MD = 156;
  {$EXTERNALSYM RSA_R_INVALID_MULTI_PRIME_KEY}
  RSA_R_INVALID_MULTI_PRIME_KEY = 167;
  {$EXTERNALSYM RSA_R_INVALID_OAEP_PARAMETERS}
  RSA_R_INVALID_OAEP_PARAMETERS = 161;
  {$EXTERNALSYM RSA_R_INVALID_PADDING}
  RSA_R_INVALID_PADDING = 138;
  {$EXTERNALSYM RSA_R_INVALID_PADDING_MODE}
  RSA_R_INVALID_PADDING_MODE = 141;
  {$EXTERNALSYM RSA_R_INVALID_PSS_PARAMETERS}
  RSA_R_INVALID_PSS_PARAMETERS = 149;
  {$EXTERNALSYM RSA_R_INVALID_PSS_SALTLEN}
  RSA_R_INVALID_PSS_SALTLEN = 146;
  {$EXTERNALSYM RSA_R_INVALID_SALT_LENGTH}
  RSA_R_INVALID_SALT_LENGTH = 150;
  {$EXTERNALSYM RSA_R_INVALID_TRAILER}
  RSA_R_INVALID_TRAILER = 139;
  {$EXTERNALSYM RSA_R_INVALID_X931_DIGEST}
  RSA_R_INVALID_X931_DIGEST = 142;
  {$EXTERNALSYM RSA_R_IQMP_NOT_INVERSE_OF_Q}
  RSA_R_IQMP_NOT_INVERSE_OF_Q = 126;
  {$EXTERNALSYM RSA_R_KEY_PRIME_NUM_INVALID}
  ...
  {$EXTERNALSYM RSA_R_MISSING_PRIVATE_KEY}
  RSA_R_MISSING_PRIVATE_KEY = 179;
  {$EXTERNALSYM RSA_R_MGF1_DIGEST_NOT_ALLOWED}
  RSA_R_MGF1_DIGEST_NOT_ALLOWED = 152;
  {$EXTERNALSYM RSA_R_MODULUS_TOO_LARGE}
  RSA_R_MODULUS_TOO_LARGE = 105;
  {$EXTERNALSYM RSA_R_MP_COEFFICIENT_NOT_INVERSE_OF_R}
  RSA_R_MP_COEFFICIENT_NOT_INVERSE_OF_R = 168;
  {$EXTERNALSYM RSA_R_MP_EXPONENT_NOT_CONGRUENT_TO_D}
  RSA_R_MP_EXPONENT_NOT_CONGRUENT_TO_D = 169;
  {$EXTERNALSYM RSA_R_MP_R_NOT_PRIME}
  ...
  {$EXTERNALSYM RSA_R_N_DOES_NOT_EQUAL_PRODUCT_OF_PRIMES}
  ...
  {$EXTERNALSYM RSA_R_RSA_OPERATIONS_NOT_SUPPORTED}
  ...
  {$EXTERNALSYM RSA_R_UNKNOWN_DIGEST}
  RSA_R_UNKNOWN_DIGEST = 166;
  {$EXTERNALSYM RSA_R_UNKNOWN_MASK_DIGEST}
  RSA_R_UNKNOWN_MASK_DIGEST = 151;
  {$EXTERNALSYM RSA_R_UNKNOWN_PADDING_TYPE}
  RSA_R_UNKNOWN_PADDING_TYPE = 118;
  {$EXTERNALSYM RSA_R_UNSUPPORTED_ENCRYPTION_TYPE}
  RSA_R_UNSUPPORTED_ENCRYPTION_TYPE = 162;
  {$EXTERNALSYM RSA_R_UNSUPPORTED_LABEL_SOURCE}
  RSA_R_UNSUPPORTED_LABEL_SOURCE = 163;
  {$EXTERNALSYM RSA_R_UNSUPPORTED_MASK_ALGORITHM}
  RSA_R_UNSUPPORTED_MASK_ALGORITHM = 153;
  {$EXTERNALSYM RSA_R_UNSUPPORTED_MASK_PARAMETER}
  RSA_R_UNSUPPORTED_MASK_PARAMETER = 154;
  {$EXTERNALSYM RSA_R_UNSUPPORTED_SIGNATURE_TYPE}
  RSA_R_UNSUPPORTED_SIGNATURE_TYPE = 155;
  {$EXTERNALSYM RSA_R_VALUE_MISSING}
